# Shell Configuration
# vi: sw=8 ts=8 noet
# Originally from https://github.com/erikw/tmux-powerline/blob/master/config/shell.sh
...
# Orignally from https://github.com/erikw/tmux-powerline/blob/master/segments/lan_ip.sh
